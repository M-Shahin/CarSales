    ...
    public partial class InitialCreate : DbMigration
    {
        public override void Up()
        {
            CreateTable(
                ...
                c => new
                    {
                        ...
                        NumberOfDoors = c.Byte(nullable: false),
                        NumberOfWheels = c.Byte(nullable: false),
                ...
                .PrimaryKey(t => t.Id)
                .ForeignKey("dbo.BodyTypes", t => t.BodyType_Id)
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.Cars", "VehicleType_Id", "dbo.VehicleTypes");
            DropForeignKey("dbo.Cars", "BodyType_Id", "dbo.BodyTypes");
            ...
            DropIndex("dbo.Cars", new[] { "VehicleType_Id" });
            DropIndex("dbo.Cars", new[] { "BodyType_Id" });
